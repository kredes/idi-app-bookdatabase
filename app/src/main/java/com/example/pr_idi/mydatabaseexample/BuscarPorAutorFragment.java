...
public class BuscarPorAutorFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_buscar_por_autor, container, false);
    }
    ...
    public void onActivityCreated(Bundle state) {
        ...
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("Cercar llibre per autor");

        bookData = new BookData(getView().getContext());
        adapter = new AdaptadorBook();
        listaLibros = (RecyclerView) getView().findViewById(R.id.lista_libros_por_autor);
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                while (it.hasNext()) {
                    Book b = (Book) it.next();
                    if (!b.getAuthor().toLowerCase().contains(query.toLowerCase())) it.remove();
                }
